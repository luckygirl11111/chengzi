...
python train_PENet_YOLOV5_l_in_Exdark.py
nohup python train_PENet_YOLOV5_l_in_Exdark.py  > train_PENet_YOLOV5_l_in_Exdark.out&
最大学习率改成了1e-3
2409930 GPU1
'''
...
if __name__ == "__main__":
    ...
    #------------------------------------------------------------------#
    save_dir            = 'log_YOLOV5l_in_Exdark'
    #------------------------------------------------------------------#
    ...
    # print('***********************************GFLOPs*************************************')
    # print('PENet YOLOv5 l的计算量和参数量')
    # # logging.info('***********************************GFLOPs*************************************')
    # print(flops / 1024 / 1024 /1024) #63.88356405124068
    # # logging.info(flops / 1024 / 1024 /1024)
    # print('***********************************Para(M)************************************')
    # # logging.info('***********************************Para(M)************************************')
    # print(params / 1024 / 1024) #44.61451816558838
    ...
    if local_rank == 0:
        ...
        log_dir         = os.path.join(save_dir, "loss_PENet_YOLOv5_l_" + str(time_str))
