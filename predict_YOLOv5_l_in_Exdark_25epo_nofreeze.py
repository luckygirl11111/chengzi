...
from yolo_YOLOv5_in_Exdark_25epo_nofreeze import YOLO, YOLO_ONNX
from nets.yolo import YoloBody
import os 
from utils.utils import (get_anchors, get_classes)
'''
运行前要修改yolo_Exdark中的model_path和classes_path
nohup python predict_YOLOv5_l_in_Exdark_25epo_nofreeze.py > test_YOLOv5_l_in_Exdark_25epo_nofreeze.out&
只用保存的第25个epoch的权值，因为EXdark是在yolov5进行微调，不需要300epoch
'''
if __name__ == "__main__":
    ...
    dir_save_path   = "/export/yuanzhian/lujiajia/paper_code_1/low_light_object_detection/yolov5-pytorch-main/test_result_YOLOv5_l_in_Exdark_25epo_nofreeze/"
    ...
    log_dir='/export/yuanzhian/lujiajia/paper_code_1/low_light_object_detection/yolov5-pytorch-main/log_YOLOV5l_in_Exdark/loss_test_YOLOv5_l_25epo_nofreeze'
    if not os.path.isdir(log_dir):#train
        os.makedirs(log_dir)
    #---------------------------------------------------#
    #   获得种类和先验框的数量
    #---------------------------------------------------#
    model_path='/export/yuanzhian/lujiajia/paper_code_1/low_light_object_detection/yolov5-pytorch-main/saved_model_YOLOv5_l_in_ExDARK_30epo_nofreeze/ep025-loss0.067-val_loss0.064.pth'
    ...
    eval_callback   = EvalCallback(net, input_shape, anchors, anchors_mask, class_names, num_classes, test_lines, log_dir, False, \
                                            eval_flag=True, period=1,map_out_path='/export/yuanzhian/lujiajia/paper_code_1/low_light_object_detection/yolov5-pytorch-main/log_YOLOV5l_in_Exdark/test_temp_map_out_YOLOv5_l_25epo_nofreeze')
    #-------------------------------------------------------------------------#
